var userInput = document.getElementsByClassName("rate");
var userSubmitRate = document.getElementsByClassName("userSubmit");
console.log(userInput)

// Array.from(userSubmitRate).forEach(function(element){
